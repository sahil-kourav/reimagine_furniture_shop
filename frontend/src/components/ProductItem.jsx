...
// //           src={image[0]}
// //           alt={name}
// //           className="w-full h-[230px] sm:h-[240px] md:h-[250px] lg:h-[270px] object-fit hover:scale-110 transition ease-in-out"
// //         />

// //         <span className="absolute top-3 left-2 bg-white/90 text-gray-800 text-[11px] px-4 py-[2px] rounded-full font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
// //           Quick View
// //         </span>
// //       </div>
