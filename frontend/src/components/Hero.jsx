...
const Hero = () => {
  ...
  return (
    <section
      className="relative w-full h-[100vh] md:h-[95vh] lg:h-[100vh] bg-cover bg-center flex items-center justify-center" data-aos="zoom-out"
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.5)), url(https://cdn.sanity.io/images/gan92b2a/burrow-production/e3c04963662e8a7e73a918e152814e332197983a-1920x1080.jpg?auto=format&fit=max&q=75&w=1440)`,
      }}
    >
      ...
      >
        <h1
          className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-4"
          data-aos="fade-up"
          data-aos-delay="50"
        >
          Discover Modern Furniture Crafted for You
        ...
        <p
          className="text-white text-base sm:text-lg md:text-xl mb-6"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          <span className="font-semibold">NestCraft</span> brings you handcrafted, sustainable furniture
...
//   return (
//     <section
//       className={`relative w-full h-[100vh] md:h-[95vh] lg:h-[100vh] bg-cover bg-center flex items-center justify-center transition-opacity duration-200 ${
//         bgLoaded ? "opacity-100" : "opacity-30"
//       }`}
//       style={{
