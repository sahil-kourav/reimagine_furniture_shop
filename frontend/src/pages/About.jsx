    ...
    <section className="bg-white text-gray-800 font-sans overflow-hidden">
      ...
      <div className="relative w-full h-[700px] md:h-[750px]">
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover brightness-[0.5]"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent flex flex-col items-center justify-center px-6 text-center" data-aos="fade-up">
          <p className="text-sm uppercase tracking-widest text-gray-300 mb-3">
            Smarter by Design
          </p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white max-w-4xl leading-tight">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 px-6 md:px-20 py-24">
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left" data-aos="fade-right">
          ...
          <p className="text-gray-600 text-base leading-relaxed">
            At <strong>NestCraft</strong>, we believe your furniture should reflect your personality and lifestyle...
          </p>
          <p className="text-gray-600 text-base leading-relaxed">
            Whether you’re styling a new space or updating an old one, we offer...
          </p>
