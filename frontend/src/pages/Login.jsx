...
//       <div className="w-full text-sm mt-[-12px]">
//         {currentState === 'Login' ? (
//           <p onClick={() => setCurrentState('Sign Up')} className="text-blue-600 hover:underline cursor-pointer">
//             Create account
//           </p>
//         ) : (
//           <p onClick={() => setCurrentState('Login')} className="text-blue-600 hover:underline cursor-pointer">
//             Login here
//           </p>
//         )}
//       </div>
...
//     <button
//         type="submit"
//         className="w-full bg-black text-white font-medium tracking-wide py-2.5 rounded-md hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition duration-200"
//       >
...
//       !trimmedEmail ||
//       !trimmedPassword ||
//       (currentState === "Sign Up" && !trimmedName)
//     ) {
//       toast.error("Please fill in all the fields!");
//       return;
//     }
...
//   return (
//  <form onSubmit={onSubmitHandler} className="flex flex-col items-center w-[90%] sm:max-w-md mx-auto py-20 gap-6 text-gray-800">
//       <div className="inline-flex items-center gap-2 mb-6 mt-10">
//         <p className="prata-regular font-bold text-3xl">{currentState}</p>
//         <hr className="border-none h-[1.5px] w-8 bg-gray-800" />
//       </div>
